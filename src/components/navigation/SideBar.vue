<template>
  <aside 
    ...
    :data-bs-theme="theme_calculated"
  >
...
import NavItemGenerator from '@/components/navigation/item/NavItemGenerator.vue'
...
export default {
  ...
  computed: {
    theme_dark () {
      return this.theme === 'dark' && !this.transparent
    },
    theme_light () {
      return this.theme === 'light' || this.transparent
    },
    theme_calculated ()
    {
      if(this.theme === 'dark' && !this.transparent) return 'dark'
      else return 'light'
    }
  },
  methods: {
