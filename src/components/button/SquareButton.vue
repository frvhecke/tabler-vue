SquareButton.vue<template>
  <a class="btn btn-square" :class="[ { disabled: disabled }, { 'active': active }, getColor(), { 'w-100' : full_width }, { 'btn-icon' : !text } ]" @click="click" :title="tooltip">
...
import { getButtonColor } from '@/services/color/ColorUtils.js'
...
export default {
  ...
  methods: {
    ...
    getColor () {
      return getButtonColor(this.color)
    }
  }
}
</script>
